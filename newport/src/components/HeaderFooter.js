...
export default function HeaderFooter() {
    ...
    function styleByActiveStatus(isActive) {
        return isActive 
        ? { fontWeight: 'bold', textDecoration: 'none', fontSize: '28px'}
        : { fontWeight: 'bold', textDecoration: 'none', color: 'black', fontSize: '24px'};
    }
      ...
      >
        ...
        <footer class="container-fluid footer1 bg-light mt-3">
            <div class="col-6 d-flex flex-shrink-2 align-items-center fa-3x mx-1 footer1 footerdiv">
                ...
                <a href="https://www.linkedin.com/in/jeremy-thornton-7aa1b9248/" target="_blank"><FontAwesomeIcon icon={faLinkedin} style={{textDecoration: 'none', color: '0077b5', height:'50px', width:'50px'}}/></a>
